...
<div class="max-w-4xl">
    ...
    <div class="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-8 pb-8">
        ...
        <div class="relative pl-8 md:pl-10 group">
            ...
            <div class="absolute -left-[9px] top-5 w-4 h-4 rounded-full bg-white border-[3px] border-blue-500 group-hover:border-amber-500 group-hover:scale-125 transition-all duration-300 shadow-sm z-10"></div>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-md border border-slate-200 transition-all duration-300 overflow-hidden mb-6">
                ...
                <div class="bg-slate-50/80 px-5 py-4 border-b border-slate-100 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="text-right flex-shrink-0">
                        ...
                        <p class="text-[11px] font-semibold text-blue-600 flex items-center justify-end bg-blue-50 px-2 py-0.5 rounded-md inline-flex">
                ...
                <!-- Body Kartu: Isi Catatan & Foto -->
                <div class="p-5 md:p-6">
                    
                    <!-- TEKS CATATAN -->
                    <div class="flex gap-4 mb-6">
                        <div class="hidden sm:flex mt-1 w-8 h-8 rounded-full bg-amber-50 items-center justify-center border border-amber-100 shrink-0">
                    ...
                    <div class="border-t border-slate-100 pt-5 mt-2">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query={{ $laporan->latitude }},{{ $laporan->longitude }}" target="_blank" class="inline-flex items-center px-2.5 py-1 text-[10px] font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-md transition-colors">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="group/foto relative rounded-xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm cursor-zoom-in">
                                <div class="absolute top-2 left-2 bg-indigo-600/80 backdrop-blur-md text-white text-[9px] font-bold px-2 py-1 rounded uppercase tracking-widest z-10">Progres Sore</div>
